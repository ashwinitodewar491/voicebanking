...
public class HtmlRenderer {
    ...
    private String renderSummary(long total, long passed, long failed, long skipped,
                                  double durationSeconds, int sessionEndedCount) {
        ...
        // Environment-stability signal, not a test outcome — a session drop that gets
        // successfully recovered from (see HomePage#recoverFromSessionEndedIfPresent) never
        // shows up as a failure at all, so this is the only place that count is visible.
