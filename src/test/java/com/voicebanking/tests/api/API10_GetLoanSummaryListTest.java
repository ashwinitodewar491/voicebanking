...
public class API10_GetLoanSummaryListTest extends BaseApiPage {
    ...
    @Test(groups = {"regression"}, description = "Should validate loan summary response structure")
    ...
    @Test(groups = {"regression"}, description = "Should validate all loan details")
    ...
    @Test(groups = {"regression"}, description = "Should validate communication addresses")
    ...
    @Test(groups = {"regression"}, description = "Should validate expected loan products")
