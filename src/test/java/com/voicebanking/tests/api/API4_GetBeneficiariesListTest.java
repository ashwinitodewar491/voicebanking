...
public class API4_GetBeneficiariesListTest extends BaseApiPage {
    ...
    @Test(description = "Should validate beneficiaries API response structure")
    ...
    @Test(description = "Should validate beneficiary schema and field values")
    ...
    @Test(description = "Should validate expected beneficiary data")
